...
$output .= '<table width="100%" border="1" cellpadding="5" cellspacing="0">
	<tr>
	<td colspan="2" align="center" style="font-size:18px"><b>Estimation</b></td>
	</tr>
	<tr>
	<td colspan="2">
	...
	<td width="35%">         
	Estimation No. : '.$invoiceValues['order_id'].'<br />
	Estimation Date : '.$invoiceDate.'<br />
	</td>
	</tr>
	</table>
	<br />
...
$output .= '<p>Approximate and minimum calculation of other company providers for Ecommerce web application <br>Powered by  selflearnwithus.com</p>';
